...
import "./contracts-upgradeable/token/ERC721/extensions/IERC721MetadataUpgradeable.sol";
...
import "./contracts-upgradeable/utils/introspection/ERC165Upgradeable.sol";
 ...
 * {ERC721Enumerable}.
 */
contract ERC721V2 is Initializable, OwnableUpgradeable, ERC165Upgradeable, IERC721Upgradeable, IERC721MetadataUpgradeable {
    ...
    function _transfer(
        ...
        require(ERC721V2.ownerOf(tokenId) == from, "ERC721: transfer from incorrect owner");
