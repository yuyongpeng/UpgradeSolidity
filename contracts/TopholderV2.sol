...
contract TopholderV2 is Initializable, OwnableUpgradeable, ERC721URIStorageUpgradeable, IERC721ReceiverUpgradeable, TopholderData {
    ...
    function setTest(string memory _test) external onlyOwner {
        test = _test;
    }
